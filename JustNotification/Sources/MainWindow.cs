    ...
    public partial class MainWindow : Form
    {
        ...
        private void MainWindow_FormClosing(object sender, FormClosingEventArgs e)
        {
            if(properties.is_tray && e.CloseReason == CloseReason.UserClosing)
            {
                ...
                {
                    Utils.ShowNotification("タスクトレイに格納されました", "JustNotification+を終了するにはタスクトレイにあるアイコンを右クリックしてください");
        ...
        {
            Utils.ShowNotification("テスト通知", "JustNotification+のテスト通知です");
        }
    }
}
